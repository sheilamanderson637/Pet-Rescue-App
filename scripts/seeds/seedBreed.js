    ...
    breedFacts: [
      {
        //breedDescription: obj.queryresult.pods[4].subpods[0].plaintext,  
        item: 'Description',
        description: 'Burmese-type medium-sized cat that is always black, including its paw pads and nose\nShort-haired with a close and shiny coat that sheds little\nEyes are large and wide-set\nMuscular, making them heavier than they look',
      },
      {
        //breedTemperment: obj.queryresult.pods[5].subpods[0].plaintext,
        item: 'Temperament',
        description: 'affectionate  |  gentle  |  inquisitive  |  intelligent  |  playful  |  social'
      },
      {
        // breedCharacteristics (properties): obj.queryresult.pods[2].subpods[0].plaintext,  
        item: 'Characteristics',
        description: 'type of breed | hybrid\nsize | medium\nweight | (6 to 12) lb  (pounds)\nhair length | short\nshedding | minimal\ngrooming | minimal\norigin | Thailand',
      },
      {
        // breedHistory: String, //obj.queryresult.pods[6].subpods[0].plaintext  
        item: 'History',
        description: 'Developed in the 1960s and named for the city of Bombay due to its intended resemblance to the black leopards of India\nResulted from combining American Shorthairs with black fur with Burmese cats'
      }
    ]
  },
  {
    ...
    breedFacts: [
      {
        //breedDescription: obj.queryresult.pods[4].subpods[0].plaintext,  
        item: 'Description',
        description: 'Member of the Siamese group of breeds with a semi-long coat\nLong and thin in its body, head, feet, and tail\nHead is wedge-shaped, straight in profile, and features ears and eyes set at an angle\nFine-boned but muscular'
      },
      {
        //breedTemperment: obj.queryresult.pods[5].subpods[0].plaintext,
        item: 'Temperament',
        description: 'curious  |  inquisitive  |  intelligent  |  interactive  |  lively  |  athletic  |  social  |  strong'
      },
      {
        // breedCharacteristics (properties): obj.queryresult.pods[2].subpods[0].plaintext,  
        item: 'Characteristics',
      ...
      },
      {
        // breedHistory: String, //obj.queryresult.pods[6].subpods[0].plaintext  
        item: 'History',
        description: 'First bred in England beginning in the 1950s by mixing Siamese with various domestic cats including British Shorthairs\nKnown until 2002 as the British Angora'
      }
    ]
  },
  {
    ...
    breedFacts: [
      ...
      },
      {
        //breedTemperment: obj.queryresult.pods[5].subpods[0].plaintext,
        item: 'Temperament',
        description: 'affectionate  |  calm  |  docile  |  gentle  |  independent  |  intelligent  |  playful  |  relaxed  |  shy  |  sweet'
      },
      {
        // breedCharacteristics (properties): obj.queryresult.pods[2].subpods[0].plaintext,  
        item: 'Characteristics',
    ...
    breedFacts: [
      {
        //breedDescription: obj.queryresult.pods[4].subpods[0].plaintext,  
        item: 'Description',
        description: 'Medium-sized cat whose short coat is always silver-tipped blue\nFur is dense and stands away from its body, appearing to shimmer in movement\nEars are proportionally large and flared\nAppears to smile\nFine boned, with long legs' 
      },
      {
        //breedTemperment: obj.queryresult.pods[5].subpods[0].plaintext,
        item: 'Temperament',
        description: 'active  |  affectionate  |  agile  |  calm  |  gentle  |  graceful  |  intelligent  |  loyal  |  playful  |  shy'
      },
      {
        // breedCharacteristics (properties): obj.queryresult.pods[2].subpods[0].plaintext,  
        item: 'Characteristics',
      ...
      },
      {
        // breedHistory: String, //obj.queryresult.pods[6].subpods[0].plaintext  
        item: 'History',
        description: 'Breed brought from the area of Arkhangel in northwestern Russia to England in the 1860s, and shown at the Crystal Palace in 1875\nReduced in numbers after World War II when the breed was revived by mixing with Siamese or British Shorthairs with blue coloration'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    breedFacts: [
      ...
      },
      {
        // breedHistory: String, //obj.queryresult.pods[6].subpods[0].plaintext  
        item: 'History',
        description: 'Breed native to the mountainous region of eastern Turkey, though further developed in England after the 1950s\nRare breed certified for show by The International Cat Association in 1979'
      }
    ]
  }
];
...
db.BreedInfo
.remove({})
.then(() => db.BreedInfo.collection.insertMany(breedInfo))
.then(data => {
